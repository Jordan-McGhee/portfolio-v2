...
const About = () => {
    ...
    return (
        <div className="mb-12 px-12 scroll-mt-20" id="about">
            ...
            <p className="text-offWhite text-lg leading-snug mb-6">When I'm not working or coding, I spend most of my time working out, exploring trails with my dog, hanging out with friends, or fighting in the rift.</p>
        </div>
    )
}
