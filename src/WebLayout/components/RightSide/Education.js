        ...
        <div>
            ...
            <ul className="scroll-mt-40 group/list" id="education">
                ...
                <li className="text-offWhite flex justify-between hover:!opacity-100 group-hover/list:opacity-50 group rounded-lg hover:bg-secondary mb-12 p-12">
                    ...
                    {/* CONTENT DIV */}
                    <div className="w-4/5">
                        <Link className="text-5xl font-medium text-white group-hover:text-accent transition-colors duration-300 ease-in-out" to='https://www.codingdojo.com/' target="_blank">Coding Dojo</Link>
                        <p className="text-5xl font-medium my-8">Full Stack Web Development Bootcamp <span className="text-white italic">(Python — Django)</span></p>
