    ...
    return (
        <div className="flex flex-col w-1/2 ">
            ...
            <div className="mb-12 px-12">
                ...
                <p className="text-white font-semibold text-7xl mb-16 ">ABOUT ME</p>
                ...
                <p className="text-offWhite text-[50px] leading-snug mb-12">Fast forward to today and I've got a <span className="font-medium text-white">bootcamp graduation and several projects under my belt.</span> My goal now is to turn my practice into a fulfilling career.</p>
